    ...
    {quests.map((quest, index) => {
      ...
      return <View key={quest.id} style={[styles.questCard, { borderColor: railColor }, completedBefore && styles.completedCard]}>
        ...
        <View style={styles.questBody}>
          ...
          <View style={styles.cardAction}><ActionButton label={completedBefore ? (quest.repeatable ? "Inspect / Repeat" : "Review Completed Quest") : readiness === "DANGER" ? "Inspect · High Risk" : "Inspect & Prepare"} onPress={() => selectQuest(quest.id)} /></View>
        </View>
      </View>;
    })}
