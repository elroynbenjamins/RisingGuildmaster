...
export const TUTORIAL_GUIDE_TOPICS: readonly TutorialGuideTopic[] = [
  {
    ...
    accent: "gold",
    bullets: [
      "Candidate cards show class and level, tactical role fit, traits, upfront fee, weekly salary, and departure deadline.",
      ...
      "Scouting narrows uncertain attributes and contract estimates. Expert scouting reveals exact figures.",
