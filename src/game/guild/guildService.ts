...
export function recruitHero(guild: GuildState, hero: Hero): GuildState {
  ...
  return { ...guild, gold: guild.gold - hero.recruitmentCost, heroes: [...guild.heroes, recruited], heroLoyaltyByHeroId: { ...guild.heroLoyaltyByHeroId, [hero.id]: createHeroLoyaltyState() } };
}
