...
export const ENCHANTMENTS: Record<string, EnchantmentDefinition> = {
  ember_edge: { id: "ember_edge", name: "Ember Edge", artisanLevel: 1, applicableSlots: ["weapon"], goldCost: 120, materials: { rough_ruby: 1, arcane_dust: 2 }, modifiers: [mod("ember_edge", "physicalAttack", "percentage", .10), mod("ember_edge", "magicPower", "percentage", .05)], specialEffectIds: ["ember_coating_12"], description: "Ruby channels heat through a weapon, improving its offense and giving physical hits a 12% chance to burn." },
  sapphire_ward: { id: "sapphire_ward", name: "Sapphire Ward", artisanLevel: 1, applicableSlots: ["armor", "helmet", "accessory1", "accessory2"], goldCost: 110, materials: { rough_sapphire: 1, arcane_dust: 2 }, modifiers: [mod("sapphire_ward", "magicDefense", "percentage", .12)], specialEffectIds: ["arcane_aftershock_guard_05"], description: "Improves magic defense; after a magic hit, a ward reduces damage from the next attack by 5%." },
