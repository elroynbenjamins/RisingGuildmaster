...
export function calculateRecruitmentFee(level: number, archetypeModifier = 0, raceModifier = 0, traitModifierValue = 0): number { return Math.round((300 + level * 100) * (1 + archetypeModifier + raceModifier + traitModifierValue)); }
