...
export function FinancesScreen({ onBack }: { onBack(): void }) {
  ...
  return <ScrollView contentContainerStyle={styles.content}>
    ...
    {arrears > 0 && <ActionButton guardMs={700} label={`PAY SALARY ARREARS · UP TO ${Math.min(arrears, guild.gold)} GOLD`} disabled={guild.gold <= 0} onPress={settle} />}
