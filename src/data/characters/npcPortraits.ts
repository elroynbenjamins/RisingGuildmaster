...
// New portraits are standalone images; legacy atlas coordinates remain intact.
const expansionEntries: NpcPortraitDefinition[] = [
  { id: "grandmother_pell", name: "Grandmother Pell", gender: "female", role: "Lighthouse keeper" },
  { id: "postmistress_yara_quill", name: "Postmistress Yara Quill", gender: "female", role: "Postmistress" },
  { id: "commander_astrid_vale", name: "Commander Astrid Vale", gender: "female", role: "Northwatch commander" },
  { id: "cinderkeeper_maela_rhun", name: "Cinderkeeper Maela Rhun", gender: "female", role: "Keeper of the hearth rites" },
  { id: "watch_captain_mirelle_sorn", name: "Watch-Captain Mirelle Sorn", gender: "female", role: "Tidewatch watch-captain" },
  { id: "archivist_nemea_quill", name: "Archivist Nemea Quill", gender: "female", role: "Veyr archivist" },
  { id: "envoy_tharos", name: "Envoy Tharos", gender: "male", role: "Concord envoy" },
  { id: "bellkeeper_orsa", name: "Bellkeeper Orsa", gender: "female", role: "Glimmerlake bellkeeper" },
  { id: "ferrymaster_neris_venn", name: "Ferrymaster Neris Venn", gender: "female", role: "Shadowfen ferrymaster" },
  { id: "historian_pell_reed", name: "Historian Pell Reed", gender: "male", role: "Shadowfen historian" },
  { id: "marshal_tavia_coal", name: "Marshal Tavia Coal", gender: "female", role: "Emberfall marshal" },
  { id: "orra_bellkeeper", name: "Orra Bellkeeper", gender: "female", role: "Keeper of the old bell roads" },
  { id: "aestra_quiet_reed", name: "Aestra Quiet-Reed", gender: "female", role: "Skyvault witness" },
  { id: "bellsmith_orra_deepnote", name: "Bellsmith Orra Deepnote", gender: "female", role: "Bellsmith" },
  { id: "innkeeper_orro", name: "Innkeeper Orro", gender: "male", role: "Innkeeper beneath the sea" },
];
export const NPC_PORTRAITS: Record<string, NpcPortraitDefinition> = Object.fromEntries([...entries, ...expansionEntries].map((entry) => [entry.id, entry]));
...
const speakerAliases: Record<string, string> = {
  ...
  "Envoy Tharos": "envoy_tharos", "The Dragon Concord": "first_crown", "The Crownless Navigator": "scale_collector", "Voice of the Crownless Host": "first_crown",
...
export function getNpcPortraitForSpeaker(speaker: string): NpcPortraitDefinition | undefined {
  const id = speakerAliases[speaker] ?? Object.values(NPC_PORTRAITS).find((portrait) => portrait.name === speaker)?.id;
