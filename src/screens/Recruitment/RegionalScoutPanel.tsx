...
export function RegionalScoutPanel({ openCalendar }: { openCalendar(): void }) {
  ...
  if (!regionalUnlocked) return <Panel style={styles.lockedPanel}>
    <Pressable accessibilityRole="button" accessibilityLabel="Regional scouting unlock requirements" accessibilityState={{ expanded }} aria-expanded={expanded} onPress={() => setExpanded(value => !value)} style={styles.lockedToggle}>
