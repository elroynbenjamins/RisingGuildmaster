...
function Preview() {
  ...
  if (screen === 'heroes') return <ManagementShell guild={guild} active="Heroes" onSelect={noop} onOpenGems={noop}><HeroesScreen openHero={noop} recruit={noop}/></ManagementShell>;
  if (screen === 'guild') return <ManagementShell guild={guild} active="Guild" onSelect={noop} onOpenGems={noop}><GuildScreen navigate={noop}/></ManagementShell>;
