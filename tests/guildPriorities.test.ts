...
describe("Guildmaster priorities", () => {
  ...
  it("starts the campaign after two recruits instead of demanding four", () => { const guild=createGuild(); guild.heroes=[{...testHero(),id:"hero-1"},{...testHero(),id:"hero-2"}]; expect(getGuildPriority(guild)).toMatchObject({id:"campaign_founding_the_guild",destination:"campaign"}); });
