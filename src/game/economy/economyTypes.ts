...
export interface GuildDayEvent {
  type: "health_recovered" | "salary_paid" | "salary_arrears" | "tavern_income" | "stamina_recovered" | "workshop_complete" | "training_complete" | "training_upgrade_complete" | "gathering_ready" | "scout_ready" | "condition_recovered" | "candidate_expired" | "contract_status" | "contract_departure" | "former_member_return" | "tavern_upgrade_complete" | "regional_threat";
  text: string;
  amount?: number;
}
...
export interface GuildPlannerDay {
  day: number;
  daysAway: number;
  events: GuildDayEvent[];
  payrollDue: number;
...
export interface GuildNextPlannerEvent extends GuildPlannerDay {}
