...
export function CandidateDetailScreen({ candidateId, onBack }: { candidateId: string; onBack(): void }) {
  ...
  return <ScrollView contentContainerStyle={styles.content}>
    ...
    {tutorialReviewComplete ? <Animated.View style={{ opacity: tutorialPulse }}><ActionButton guardMs={700} label="RETURN TO CANDIDATES" onPress={onBack} /></Animated.View> : null}
  </ScrollView>;
}
