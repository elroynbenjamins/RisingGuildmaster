...
import { calculateTrainingQuote, getTrainingProgressionLimit, grantTrainingXp, startHeroTraining, startTrainingGroundUpgrade, trainingCapacity } from "../src/game/training/trainingService";
