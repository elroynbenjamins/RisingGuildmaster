...
describe("quest loop", () => {
  ...
  it("combines shared enemy and objective XP at the common progression rate", () => { const quest = QUESTS.goblin_patrol!; expect(getQuestEnemyXpPool(quest)).toBe(300); expect(getQuestXpForHero(testHero(), quest, 2)).toBe(563); });
