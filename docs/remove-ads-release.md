...
Remove Ads disables voluntary rewarded ads and 20-day milestone prompts across local saves. It does not automatically grant ad-viewing rewards. Free daily login gems remain available. Reinstalling or changing devices requires restoration with the same Google Play account. This is not a separate Guildmaster cloud-account system.
