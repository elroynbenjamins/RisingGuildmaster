...
export function calculateRecruitmentFee(level: number, attributeTotal: number, archetypeModifier = 0, raceModifier = 0, traitModifierValue = 0): number { return Math.round((100 + level * 100 + attributeTotal * 3) * (1 + archetypeModifier + raceModifier + traitModifierValue)); }
