...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.gold, fontSize: 9, fontWeight: "500", letterSpacing: .3 },
  ...
  resourceLabel: { color: colors.muted, fontSize: 7, fontWeight: "500", letterSpacing: .3 },
  ...
  levelBadge: { minWidth: 82 }, levelLabel: { color: colors.gold, fontSize: 8, fontWeight: "500" }, level: { color: colors.text, fontSize: 19, fontWeight: "900", marginTop: 2 },
  flex: { flex: 1 }, progress: { color: colors.text, fontSize: 10, fontWeight: "500" }, track: { backgroundColor: colors.panel2, borderColor: colors.border, height: 6, marginTop: 5, overflow: "hidden", borderWidth: 0, borderRadius: 3, }, fill: { backgroundColor: colors.green, height: "100%" }, manageHint: { color: colors.gold, fontSize: 8, fontWeight: "500", letterSpacing: .3, marginTop: 5 },
  ...
  orders: { gap: 7 },
  orderPressable: { minHeight: 104 }, pressed: { opacity: .76, transform: [{ translateY: 1 }] },
  orderCard: { alignItems: "stretch", backgroundColor: colors.panel, flexDirection: "row", minHeight: 104, overflow: "hidden", borderWidth: 0, borderRadius: 12, },
  orderRail: { width: 4 }, orderIcon: { alignItems: "center", backgroundColor: "transparent", justifyContent: "center", width: 58 }, orderCopy: { flex: 1, paddingHorizontal: 10, paddingVertical: 8 }, orderHeading: { alignItems: "center", flexDirection: "row", justifyContent: "space-between" }, orderBadge: { fontSize: 8, fontWeight: "500", letterSpacing: .3 }, orderArrow: { color: colors.muted, fontSize: 18, fontWeight: "900", lineHeight: 18 }, orderTitle: { color: colors.text, fontSize: 14, fontWeight: "900", marginTop: 1 }, orderText: { color: colors.muted, fontSize: 10, lineHeight: 14, marginTop: 3 }, orderAction: { fontSize: 8, fontWeight: "500", letterSpacing: .3, marginTop: 5 },
