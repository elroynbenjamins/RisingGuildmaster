    ...
    {quests.map((quest, index) => {
      ...
      return <View key={quest.id} style={[styles.questCard, { borderColor: railColor }, completedBefore && styles.completedCard]}>
        ...
        <View style={styles.questBody}>
          ...
          <View style={styles.cardAction}><ActionButton iconId={quest.questType==="boss"?"boss":"quests"} label={completedBefore ? (quest.repeatable ? "Prepare Repeat Quest" : "Review Completed Quest") : readiness === "DANGER" ? "Prepare · High Risk" : "Prepare Quest"} onPress={() => selectQuest(quest.id)} /></View>
        </View>
      </View>;
    })}
...
const styles = StyleSheet.create({
  ...
  boardIdentity:{alignItems:"center",flexDirection:"row",flexShrink:1,gap:7,minWidth:0},
  title: { color: colors.text, flexShrink:1, fontSize: 27, fontWeight: "900" },
  ...
  locationValue: { color: colors.text, fontSize: 11, fontWeight: "900", marginTop: 1, maxWidth: 120 },
