...
export interface UiPreferences { reduceCombatEffects:boolean; confirmEndTurn:boolean; defaultCombatZoom:"fit"|"close"; compactQuestCards:boolean; themeId?:"guild_dark"|"oled_dark"|"high_contrast" }
