...
describe("hero combat resources", () => {
  ...
  it("recovers resources but not HP between encounters", () => expect(recoverBetweenEncounters(instance({ currentHP: 25 }))).toMatchObject({ currentHP: 25, currentMana: 60, currentStamina: 60 }));
});
