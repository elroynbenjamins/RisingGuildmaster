...
export type RecipeUnlockSource = "roguelite_elite" | "roguelite_boss";
...
export interface EnchantmentDefinition { id: string; name: string; artisanLevel: number; applicableSlots: EquipmentSlot[]; goldCost: number; materials: Partial<Record<MaterialId, number>>; modifiers: Modifier[]; description: string }
