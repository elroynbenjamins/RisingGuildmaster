...
const styles = StyleSheet.create({
  ...
  reachable:{backgroundColor:"rgba(75,191,169,.18)"},
  movementBoundary:{position:"absolute",left:0,right:0,top:0,bottom:0,zIndex:3},
  boundaryTop:{borderTopColor:"#ffe04b",borderTopWidth:2},
  boundaryRight:{borderRightColor:"#ffe04b",borderRightWidth:2},
  boundaryBottom:{borderBottomColor:"#ffe04b",borderBottomWidth:2},
  boundaryLeft:{borderLeftColor:"#ffe04b",borderLeftWidth:2},
