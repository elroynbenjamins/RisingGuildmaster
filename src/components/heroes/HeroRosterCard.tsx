...
const styles = StyleSheet.create({
  ...
  heroName: { fontWeight: "900", fontSize: 21, lineHeight: 27},
  ...
  statusDetail: {letterSpacing: .15, fontWeight: "700", fontSize: 11, lineHeight: 16},
  meterBlock: { gap: 2 },
  meterHeader: { alignItems: "center", flexDirection: "row", justifyContent: "space-between" },
  meterLabel: { fontWeight: "800", fontSize: 10, letterSpacing: 0},
  meterValue: { fontWeight: "800", fontSize: 11},
  ...
  inspect: { fontWeight: "800", fontSize: 12, letterSpacing: 0},
});
