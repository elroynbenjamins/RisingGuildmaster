...
export function createQuestEncounter(encounterId: string, random: RandomSource, difficultyId: GameDifficultyId = "standard", enemyLevelModifier = 0): GeneratedEnemy[] {
