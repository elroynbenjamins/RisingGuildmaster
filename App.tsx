...
function Game() {
  ...
  if (route.name === "campaign") return <CampaignScreen guild={guild} updateGuild={updateGuild} onBack={() => main("Quests")} openWorld={() => main("World")} openRegion={(regionId) => setRoute({ name: "regionMap", regionId })} startQuest={(questId, campaignNodeId) => setRoute({ name: "questBriefing", questId, campaignNodeId, back: "campaign" })} />;
