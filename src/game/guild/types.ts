...
export interface UiPreferences { reduceCombatEffects:boolean; confirmEndTurn:boolean; defaultCombatZoom:"fit"|"close"; compactQuestCards:boolean; enemyTurnSpeed:"normal"|"fast"|"very_fast"; themeId?:"guild_dark"|"oled_dark"|"high_contrast" }
