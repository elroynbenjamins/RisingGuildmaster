...
export interface TrainingSession { id: string; heroId: string; programId: TrainingProgramId; startDay: number; completionDay: number; goldCost: number; xpReward: number; levelCap?: number }
