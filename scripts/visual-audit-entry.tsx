...
fixture.potions={...fixture.potions,minor_healing_potion:6,mana_tonic:4,stamina_draught:2};
...
return <Boundary><View style={{flex:1,backgroundColor:'#101416'}}>{mainTabs[name]?<ManagementShell guild={guild} active={mainTabs[name]} onSelect={noop} onOpenActivity={noop} onOpenGems={noop}><Screen {...common}/></ManagementShell>:<Screen {...common}/>}</View></Boundary>;
}
