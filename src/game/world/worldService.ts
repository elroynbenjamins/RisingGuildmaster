...
export function discoverRegionSettlements(state: WorldState, regionId: string): WorldState { const settlementIds = REGIONS[regionId]?.settlementIds ?? []; return { ...state, discoveredSettlementIds: [...new Set([...state.discoveredSettlementIds, ...settlementIds])] }; }
