...
export interface DiceRollDisplayProps { diceType: 20; roll: number; modifier: number; attackBonus?: number; skillModifier?: number; total: number; targetValue: number; result: "critical" | "hit" | "miss" | "critical_miss" }
export function DiceRollDisplay({ diceType, roll, modifier, attackBonus, skillModifier, total, targetValue, result }: DiceRollDisplayProps) {
