...
describe("day milestone ad presentation", () => {
  ...
  it("requires the milestone message and records it only after the reward is earned", async () => {
    ...
    showMilestoneAd.mockResolvedValue({ transactionId: "milestone-15", source: "rewarded_ad", gems: 5, verified: true });
    ...
    expect(updates[0]!.viewedAdMilestoneDays).toContain(15);
