...
export const ARTISAN_BUILDINGS: Record<ArtisanType, ArtisanBuildingTierDefinition[]> = {
  blacksmith: [
    ...
    { level: 2, name: "Steelworks", goldCost: 1400, durationDays: 3, requiredSkillId: "advanced_workshops" },
    { level: 3, name: "Master Forge", goldCost: 2400, durationDays: 4, requiredSkillId: "masterwork_district" },
  ],
  tailor: [
    { level: 1, name: "Loomhouse", goldCost: 700, durationDays: 2, requiredSkillId: "loom_charter" },
    { level: 2, name: "Runewoven Atelier", goldCost: 1200, durationDays: 3, requiredSkillId: "advanced_workshops" },
    { level: 3, name: "Master Clothier Hall", goldCost: 2000, durationDays: 4, requiredSkillId: "masterwork_district" },
  ],
  jeweler: [
    { level: 1, name: "Lapidary Atelier", goldCost: 1000, durationDays: 3, requiredSkillId: "lapidary_charter" },
    { level: 2, name: "Enchanter's Gallery", goldCost: 1700, durationDays: 4, requiredSkillId: "advanced_workshops" },
    { level: 3, name: "Master Gemworks", goldCost: 2800, durationDays: 5, requiredSkillId: "masterwork_district" },
  ],
};
