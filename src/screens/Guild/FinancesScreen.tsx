...
export function FinancesScreen({ onBack }: { onBack(): void }) {
  ...
  const weeklyPayroll = activeContracts.reduce((sum, contract) => sum + contract.weeklySalary, 0);
  const previewLines = [
