...
it("suppresses ads for owners, preserves legacy history, and rejects invalid milestones", () => {
  ...
  expect(pendingDayMilestone({ ...guild, currentDay: 44, viewedAdMilestoneDays: [30] })).toBeNull();
  expect(pendingDayMilestone({ ...guild, currentDay: 45, viewedAdMilestoneDays: [30] })).toBe(45);
