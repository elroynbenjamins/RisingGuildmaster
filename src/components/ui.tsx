...
const styles = StyleSheet.create({
  ...
  button: { paddingHorizontal: 18, paddingVertical: 12, alignItems: "center", minHeight: 44, justifyContent: "center", borderWidth: 0, borderRadius: 10, },
  secondaryButton: { paddingHorizontal: 16, paddingVertical: 10, alignItems: "center", minHeight: 44, justifyContent: "center", borderWidth: 0, borderRadius: 10, },
