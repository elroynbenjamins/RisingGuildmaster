...
<Text style={styles.note}>The normal board refresh costs gold or waits for its weekly free refresh. This guided refresh is free once.</Text><ActionButton label="Begin Tutorial" onPress={onBegin} /><SecondaryButton label="Skip Tutorial" onPress={onSkip} /></Panel></ScrollView>;
}
const styles = StyleSheet.create({ screen: { backgroundColor: colors.background, flexGrow: 1, justifyContent: "center", padding: 22, paddingVertical: 34 }, panel: { borderColor: colors.gold, gap: 14 }, step: { color: colors.gold, fontSize: 10, fontWeight: "900", letterSpacing: 1.8 }, title: { color: colors.text, fontSize: 28, fontWeight: "900" }, body: { color: colors.text, lineHeight: 21 }, guide: { color: colors.text, fontSize: 12, lineHeight: 18 }, note: { color: colors.muted, lineHeight: 18, fontStyle: "italic" } });
