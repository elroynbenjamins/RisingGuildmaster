...
const styles = StyleSheet.create({
  content: { padding: 18, paddingBottom: 35 }, header: { flexDirection: "row", justifyContent: "space-between", marginBottom: 16 }, title: { color: colors.text, fontSize: 30, fontWeight: "900" }, count: { color: colors.gold, marginTop: 3 },
  label: { color: colors.muted, fontSize: 10, letterSpacing: 1.5, fontWeight: "900" }, overview: { flexDirection: "row", gap: 7, marginBottom: 12 }, overviewItem: { alignItems: "center", backgroundColor: colors.panel, borderColor: colors.border, borderRadius: 8, borderWidth: 1, flex: 1, padding: 9 }, overviewValue: { color: colors.text, fontSize: 20, fontWeight: "900" }, overviewLabel: { color: colors.gold, fontSize: 8, fontWeight: "900", letterSpacing: .7, marginTop: 2 },
  ...
  search: { backgroundColor: colors.panel, borderColor: colors.border, borderRadius: 10, borderWidth: 1, color: colors.text, marginBottom: 11, minHeight: 46, paddingHorizontal: 13 }, sortHeading: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", marginTop: 5 }, resultCount: { color: colors.gold, fontSize: 9, fontWeight: "900", letterSpacing: .7 },
});
