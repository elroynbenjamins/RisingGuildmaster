...
describe("tactical grid", () => {
  ...
  it("applies class and race movement before clamping", () => { expect(calculateMovementRange(20, CLASSES.ranger, RACES.elf)).toBe(5); expect(calculateMovementRange(20, CLASSES.paladin, RACES.dwarf)).toBe(2); expect(calculateMovementRange(100, CLASSES.ranger, RACES.elf)).toBe(5); });
