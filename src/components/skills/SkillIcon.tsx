...
const ATLASES: Record<SkillIconAtlasId, number> = { hero: HERO_ATLAS, enemy: ENEMY_ATLAS, ashStory: ASH_STORY_ATLAS };
const ATLAS_GRID_SIZE: Record<SkillIconAtlasId, number> = { hero: 6, enemy: 6, ashStory: 3 };
