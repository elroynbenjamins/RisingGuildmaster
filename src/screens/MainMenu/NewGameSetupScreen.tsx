...
const styles = StyleSheet.create({
  ...
  summary: { borderColor: colors.gold, marginBottom: 12, marginTop: 16 }, summaryLabel: { color: colors.gold, fontSize: 9, fontWeight: "900", letterSpacing: 1.4 }, summaryName: { color: colors.text, fontSize: 18, fontWeight: "900", marginTop: 3 }, summaryText: { color: colors.muted, fontSize: 11, lineHeight: 17, marginTop: 4 }, pressed:{opacity:.76,transform:[{translateY:1}]}
});
